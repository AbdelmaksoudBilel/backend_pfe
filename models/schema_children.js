...
const ChildSchema = new Schema({
  ...
  PR_QN1_A:  { type: Number, min: 0, max: 2, default: null }, // TSA / TED
  PR_QN1_B:  { type: Number, min: 0, max: 2, default: null }, // Autre trouble rare
  PR_QN1_C:  { type: Number, min: 0, max: 2, default: null }, // Asthme/respiratoire
  PR_QN1_D:  { type: Number, min: 0, max: 2, default: null }, // Trouble santé mentale
  PR_QN1_E:  { type: Number, min: 0, max: 2, default: null }, // Démence/Alzheimer
  PR_QN1_F:  { type: Number, min: 0, max: 2, default: null }, // Diabète
  PR_QN1_G:  { type: Number, min: 0, max: 2, default: null }, // Épilepsie
  PR_QN1_H:  { type: Number, min: 0, max: 2, default: null }, // Lésion cérébrale
